...
#define MQTT_BROKER 1000
#define MQTT_PORT 1883
#define MQTT_TOPIC "test"
#define MQTT_PAYLOAD "FUCK YOU"

#define WIFI_SSID "tp_freak_!5G"
#define WIFI_PASS "lolkek227@"

const char *ssid = "tp_freak_!5G";
...
static void mqtt_app_start(void) {
  esp_mqtt_client_config_t mqtt_cfg = {
      .broker =
          {
              .address.uri = "mqtt://192.168.0.147:1883",
